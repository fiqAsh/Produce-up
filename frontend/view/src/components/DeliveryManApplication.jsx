...
const ApplyForDeliveryman = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (selectedMarket) {
      await applyForDeliveryman(selectedMarket._id);
    }
  };
  ...
  return (
    <div className="p-4 max-w-3xl mx-auto">
      ...
      >
        ...
        >
          {loading ? "Submitting..." : "Apply as Deliveryman"}
        </button>
...
export default ApplyForDeliveryman;
